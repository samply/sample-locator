...
@Component({
  selector: 'app-search-exists',
  templateUrl: './search-exists.component.html',
  styleUrls: ['./search-exists.component.scss']
})
export class SearchExistsComponent implements OnInit, OnDestroy {
